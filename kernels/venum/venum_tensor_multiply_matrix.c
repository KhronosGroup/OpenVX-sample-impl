        ...
        vx_enum type)
{
    ...
    switch (type)
    {
    case VX_TYPE_UINT8: TensorMultiplyMatrix_S8((vx_uint8 *)src1, dims1, src1_strides, (vx_uint8 *)src2, dims2, src2_strides, 
                        (vx_uint8 *)src3, src3_strides, dst_strides, (vx_uint8 *)dst);

    case VX_TYPE_INT8: TensorMultiplyMatrix_U8((vx_int8 *)src1, dims1, src1_strides, (vx_int8 *)src2, dims2, src2_strides, 
