...
SYSDEFS  += OPENVX_USE_U1
#SYSDEFS  += OPENVX_USE_PIPELINING
#SYSDEFS  += OPENVX_USE_STREAMING
SYSDEFS  += OPENVX_USE_USER_DATA_OBJECT
SYSDEFS  += OPENVX_CONFORMANCE_VISION
SYSDEFS  += OPENVX_CONFORMANCE_NEURAL_NETWORKS
SYSDEFS  += OPENVX_CONFORMANCE_NNEF_IMPORT
