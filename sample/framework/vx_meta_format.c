...
VX_API_ENTRY vx_status VX_API_CALL vxQueryMetaFormatAttribute(vx_meta_format meta, vx_enum attribute, void *ptr, vx_size size)
{
    ...
    switch(attribute)
    {
        /**********************************************************************/
        case VX_IMAGE_FORMAT:
            if (sizeof(meta->dim.image.format) == size) {
            ...
            break;
        case VX_IMAGE_HEIGHT:
            if (sizeof(meta->dim.image.height) == size) {
            ...
            break;
        case VX_IMAGE_WIDTH:
            if (sizeof(meta->dim.image.width) == size) {
        ...
        /**********************************************************************/
        case VX_ARRAY_CAPACITY:
            if (sizeof(meta->dim.array.capacity) == size) {
            ...
            break;
        case VX_ARRAY_ITEMTYPE:
            if (sizeof(meta->dim.array.item_type) == size) {
        ...
        /**********************************************************************/
        case VX_PYRAMID_FORMAT:
            if (sizeof(meta->dim.pyramid.format) == size) {
            ...
            break;
        case VX_PYRAMID_HEIGHT:
            if (sizeof(meta->dim.pyramid.height) == size) {
            ...
            break;
        case VX_PYRAMID_WIDTH:
            if (sizeof(meta->dim.pyramid.width) == size) {
            ...
            break;
        case VX_PYRAMID_LEVELS:
            if (sizeof(meta->dim.pyramid.levels) == size) {
            ...
            break;
        case VX_PYRAMID_SCALE:
            if (sizeof(meta->dim.pyramid.scale) == size) {
        ...
        /**********************************************************************/
        case VX_SCALAR_TYPE:
            if (sizeof(meta->dim.scalar.type) == size) {
        ...
        /**********************************************************************/
        case VX_MATRIX_TYPE:
            if (sizeof(meta->dim.matrix.type) == size) {
            ...
            break;
        case VX_MATRIX_ROWS:
            if (sizeof(meta->dim.matrix.rows) == size) {
            ...
            break;
        case VX_MATRIX_COLUMNS:
            if (sizeof(meta->dim.matrix.cols) == size) {
        ...
        /**********************************************************************/
        case VX_DISTRIBUTION_BINS:
            if (sizeof(meta->dim.distribution.bins) == size) {
            ...
            break;
        case VX_DISTRIBUTION_RANGE:
            if (sizeof(meta->dim.distribution.range) == size) {
            ...
            break;
        case VX_DISTRIBUTION_OFFSET:
            if (sizeof(meta->dim.distribution.offset) == size) {
        ...
        /**********************************************************************/
        case VX_REMAP_SOURCE_WIDTH:
            if (sizeof(meta->dim.remap.src_width) == size) {
            ...
            break;
        case VX_REMAP_SOURCE_HEIGHT:
            if (sizeof(meta->dim.remap.src_height) == size) {
            ...
            break;
        case VX_REMAP_DESTINATION_WIDTH:
            if (sizeof(meta->dim.remap.dst_width) == size) {
            ...
            break;
        case VX_REMAP_DESTINATION_HEIGHT:
            if (sizeof(meta->dim.remap.dst_height) == size) {
        ...
        /**********************************************************************/
        case VX_LUT_TYPE:
            if (sizeof(meta->dim.lut.type) == size) {
            ...
            break;
        case VX_LUT_COUNT:
            if (sizeof(meta->dim.lut.count) == size) {
        ...
        /**********************************************************************/
        case VX_THRESHOLD_TYPE:
            if (sizeof(meta->dim.threshold.type) == size) {
        ...
        /**********************************************************************/
        case VX_VALID_RECT_CALLBACK:
            if (sizeof(meta->set_valid_rectangle_callback) == size) {
        ...
        /**********************************************************************/
        case VX_OBJECT_ARRAY_ITEMTYPE:
            if (sizeof(meta->dim.object_array.item_type) == size) {
            ...
            break;
        case VX_OBJECT_ARRAY_NUMITEMS:
            if (sizeof(meta->dim.object_array.num_items) == size) {
        ...
        /**********************************************************************/
        case VX_TENSOR_NUMBER_OF_DIMS:
            if (sizeof(meta->dim.tensor.number_of_dimensions) == size) {
        ...
        case VX_TENSOR_DIMS:
            ...
            break;
        case VX_TENSOR_DATA_TYPE:
            if (sizeof(meta->dim.tensor.data_type) == size)
            {
            ...
            break;
        case VX_TENSOR_FIXED_POINT_POSITION:
            if (sizeof(meta->dim.tensor.fixed_point_position) == size) //??
            {
